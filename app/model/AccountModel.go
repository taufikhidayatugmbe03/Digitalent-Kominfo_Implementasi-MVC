...
// Account => struct for account's atribute
type Account struct {
...
// AccountModel => struct DB for account
type AccountModel struct {
	DB *gorm.DB
}

// InsertNewAccount => function for inserting new account
...
// GetAccountDetail => function for getting account detail
